...
public class LookMouse : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        _mouseX = Input.GetAxis("Mouse X") * _sensivitySettings.SensitivityMouse * Time.deltaTime + _xOffset * Time.deltaTime;
        _mouseY = Input.GetAxis("Mouse Y") * _sensivitySettings.SensitivityMouse * Time.deltaTime + _yOffset * Time.deltaTime;
